...
22. Добавим конфигурацию для корректной работы проксирования приложения с помощью **nginx** в  **Vagrantfile** добавим :
...
32. Используем роли **db** и **app** в шаблонах **packer** - **packer_app.yml и packer_db.yml**:
```
_packer_app.yml_
---
